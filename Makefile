...
cast-storage-nft-contract:
	cast storage --rpc-url $(SEPOLIA_RPC_URL) -e $(ETHERSCAN_API_KEY) 0x9830b32f7210f0857A859c2A86387e4d1bB760B8

# deploy-sepolia:
# 	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE__KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvv
...
# Get function selector cast sig "cheaperWithdraw()" compare this with that of metamask
# can be used to ensure that the right contract function is indeed called